...
export default function Manifesto() {
    ...
    return (
        <section ref={containerRef} className="relative py-20 px-6 w-full min-h-[50vh] flex items-center justify-center overflow-hidden bg-textDark">
            {/* Parallax Background */}
            <div
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
                ...
                <p ref={textRef} className="text-2xl md:text-4xl lg:text-[2.75rem] font-heading font-bold text-white leading-tight">
