        ...
        {studies.map((study, i) => (
          <div key={i} className="group flex flex-col gap-6 cursor-pointer">
            <div className="w-full aspect-video rounded-[2rem] overflow-hidden relative shadow-lg">
              ...
              ></div>
              <div className="absolute inset-0 bg-primary opacity-0 group-hover:opacity-40 mix-blend-multiply transition-opacity duration-500"></div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between">
                ...
                <div className="w-10 h-10 rounded-full bg-background border border-gray-200 flex items-center justify-center -translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300">
                  <ArrowRight size={20} className="text-accent" />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                <div>
                  <h4 className="font-mono text-xs font-bold tracking-widest uppercase text-gray-400 mb-2">Challenge</h4>
                  <p className="text-sm font-body text-gray-600 leading-relaxed">{study.challenge}</p>
                </div>
                <div>
                  <h4 className="font-mono text-xs font-bold tracking-widest uppercase text-gray-400 mb-2">Deployed Solution</h4>
